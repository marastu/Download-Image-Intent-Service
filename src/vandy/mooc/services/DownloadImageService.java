...
public class DownloadImageService extends IntentService {
    ...
    public void onHandleIntent(Intent intent) {
        ...
        // @@ TODO -- you fill in here.
          final Uri path=Utils.downloadImage(getApplicationContext(), uri, directorypath);
    ...
    private void sendPath(Messenger messenger, 
    	...
    	final Uri uri=Uri.parse(IMAGE_URL);
    	
        Message message =makeReplyMessage(pathToImageFile, uri);
            // Send the path to the image file back to the
            // MainActivity.
            // @@ TODO -- you fill in here.
        try{
    ...
    private Message makeReplyMessage(Uri pathToImageFile,
        ...
        // Put the URL to the image file ino the Bundle via the
        // IMAGE_URL key.
